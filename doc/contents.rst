...
Alinea ear_tracking documentation
#########################################################################
...
- A `PDF <../latex/ear_tracking.pdf>`_ version of |ear_tracking| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:ear_tracking:ear_tracking>`__ wiki.
